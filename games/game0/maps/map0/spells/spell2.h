...
bbFlag bbSpell_Spell2_Constructor(bbSpell** self, void* Spells)
{
    ...
    bbDictionary_add(spells->spellCodes, "SPELL2", spellHandle);

    spell->spellIcon = 101+2;

    spell->fTable.Constructor =
            bbSpellFunctions_getInt(&spells->functions,
                                    SpellConstructor, "SPELL2");

    spell->fTable.Destructor =
            bbSpellFunctions_getInt(&spells->functions,
                                    SpellDestructor, "SPELL2");

    spell->fTable.SetActive =
            bbSpellFunctions_getInt(&spells->functions,
                                    SpellSetActive, "SPELL2");

    spell->fTable.SetInactive =
            bbSpellFunctions_getInt(&spells->functions,
                                    SpellSetInactive, "SPELL2");

    spell->fTable.ReceiveStr =
            bbSpellFunctions_getInt(&spells->functions,
                                    SpellReceiveStr, "SPELL2");

    spell->fTable.ReceiveClick =
            bbSpellFunctions_getInt(&spells->functions,
                                    SpellReceiveClick, "SPELL2");
...
bbFlag bbSpell_Spell2_Destructor(bbSpell** self, void* spells)
{
    return Success;
}
/*
bbFlag bbSpell_Spell2_SetActive(bbSpell* spell, void* Spells, bbDummySender* server, U64 gameTime)
{
    bbHere();
    bbSpells* spells = (bbSpells*)Spells;
...
bbFlag bbSpell_Spell2_SetInactive(bbSpell* self, void* spells)
{
    self->state = SpellInactive;
    return Success;
}

bbFlag bbSpell_Spell2_ReceiveStr(bbSpell* spell, void* Spells, char* answer)
{
...
/*
bbFlag bbSpell_Spell2_ReceiveClick(bbSpell* spell, void* Spells, bbMapCoords MC, bbDummySender* server, U64 gameTime)
{
