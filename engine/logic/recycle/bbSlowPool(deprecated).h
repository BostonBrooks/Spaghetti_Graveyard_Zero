...
typedef struct{
        bbSlowPool_Handle head;
        bbSlowPool_Handle tail;
}  bbSlowPool_List;

typedef struct{
    bbSlowPool_Handle head;
    bbSlowPool_Handle tail;
}  bbSlowPool_ListElement;

#define bbSlowPool_NULL 0

typedef struct {
    void* p_Pool; //TODO keep track of pool externally?
    bbSlowPool_Handle p_Handle;
    //TODO bool p_InUse
      // keep track of if in use for storage and retrieval
} bbSlowPool_Header;
...
typedef struct {
    ...
    U16 p_level1;
    U16 p_level2;
    U16 p_map; //TODO keep track of map externaly?
...
/// create a new pool
I32 bbSlowPool_newPool(void** pool, I32 sizeOf, I32 level1, I32 level2);
